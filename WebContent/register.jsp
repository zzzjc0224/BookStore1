					...
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput"
									name="email"  placeholder="请输入有效的邮箱地址" value="${rfb.email}"/></td>
								<td><font color="#999999">${errors.email}</font></td>
							</tr>
							<tr> 
								<td style="text-align:right">会员名：</td>
								<td>
									<input type="text" class="textinput" name="username" value="${rfb.username}" placeholder="用户名设置至少6位"/>
								</td>
								<td><font color="#999999">${errors.username}</font></td>
							</tr>
							<tr>
								<td style="text-align:right">密码：</td>
								<td><input type="password" class="textinput"
									name="password" value="${rfb.password }" placeholder="密码设置至少6位"/></td>
								<td><font color="#999999">${errors.password}</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2">&nbsp;&nbsp;<input type="radio"
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
									name="gender" value="F" /> 女</td>
							</tr>
							<tr>
								<td style="text-align:right">联系电话：</td>
								<td colspan="2"><input type="text" class="textinput" value="${rfb.telephone }"
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td><font color="#999999">${errors.imageCode}</font></td>
							</tr>
							<tr>
