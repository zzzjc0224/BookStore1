...
<body class="main">
			...
			<tr>
				...
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form action="modifyUserInfo.logined.do" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;<input type="radio" id="mgen"
												name="gender" value="M" checked="checked" /> 男
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
												type="radio" id="fgen" name="gender" value="F" /> 女</td>
										</tr>
										<tr>
	...
	var ipt
	if(gender=='M'){
		ipt=document.getElementById("mgen");
	}else{
		ipt=document.getElementById("fgen");
	}
