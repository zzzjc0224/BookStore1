											...
											<td><table cellspacing="1" class="carttable">
												...
												<c:forEach items="${cart.itemsMap}" var="entry" varStatus="vs">
													...
													<tr>
														...
														<td width="40%"><c:out value="${entry.value.book.name}"></c:out></td>
														<td width="10%"><c:out value="${entry.value.book.price}"></c:out></td>
														<td width="10%"><c:out value="${entry.value.book.category}"></c:out></td>
														<td width="10%"><input name="text" type="text"
															value="${entry.value.numbers}" style="width:20px" readonly="readonly" /></td>
												...
												<table cellspacing="1" class="carttable">
													<tr>
														<td style="text-align:right; padding-right:40px;"><font
															style="color:#FF0000">合计：&nbsp;&nbsp;${cart.price}元</font></td>
													</tr>
												</table>
												...
												<p style="text-align:right">
													<img src="images/gif53_029.gif" width="204" height="51"
														border="0" onclick="javascript:submitOrder()"/>
												</p></td>
										</tr>
									</table></td>
							</tr>
