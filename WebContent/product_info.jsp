									...
									<tr>
										<td width="30%">
											...
											<div class="divbookcover">
												<p>
													<img src="bookimage/${book.imgurl}_w.jpg"
														width="213" height="269" border="0" />
												</p>
											</div>

											<div style="text-align:center; margin-top:25px">
												<a href="addToCart?id=${book.id}">
										...
										<td style="padding:20px 5px 5px 5px"><img
											...
											class="bookname">&nbsp;&nbsp;<c:out value="${book.name}"></c:out></font>

											<hr />售价：<font color="#FF0000"><c:out value="￥${book.price}"></c:out></font>
											<hr /> <c:out value="类别:${book.category}"></c:out>

											<hr />
											<p>
												<b>内容简介：</b>
											</p><c:out value="${book.description}"></c:out></td>
									</tr>
								</table></td>
						</tr>
					</table>
